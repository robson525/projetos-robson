...
if (isset($_SESSION['anexo9']) && $_SESSION['anexo9']) {
    $ficha = true;
        
} elseif (($_SESSION['selecionar'] || $submetido)) {
    $prontuario = new Prontuario('1_anexo9');
    $_SESSION['anexo9'] = $prontuario->buscarFichaId($_SESSION['id_ficha']);
    $ficha = $_SESSION['anexo9']?true:false;
} else {
    $ficha = false;
}
...
<center>
    <h2>Anexo 9: Anaminese</h2>
</center>

<div id="div_ficha">

    <form id="form_ficha" name="form_ficha" method="post" action="index.php?form=9" >
