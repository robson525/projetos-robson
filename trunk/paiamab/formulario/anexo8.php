...
if (isset($_SESSION['anexo8']) && $_SESSION['anexo8']) {
    $ficha = true;
        
} elseif (($_SESSION['selecionar'] || $submetido)) {
    $prontuario = new Prontuario('1_anexo8');
    $_SESSION['anexo8'] = $prontuario->buscarFichaId($_SESSION['id_ficha']);
    $ficha = $_SESSION['anexo8']?true:false;
} else {
    $ficha = false;
}
...
<center>
    <h2>Anexo 8: Avaliação do Joelho</h2>
</center>

<div id="div_ficha">

    <form id="form_ficha" name="form_ficha" method="post" action="index.php?form=8" >
        ...
        <table id="tab_anexo" border="0" align="center" width="80%">
            ...
            <tr>
                ...
                <td class="td_dir"> <input id="entrevistador" name="entrevistador" type="text" maxlength="100" style="width:98%" value="<?php echo $ficha ? $_SESSION['anexo9']['entrevistador'] : ""; ?>"> </td>
                <td class="td_esq">Data: </td>
                <td class="td_dir"> <input id="data" name="data" type="text" maxlength="10" value="<?php echo $ficha ? $_SESSION['anexo9']['data'] : ""; ?>"> </td>

            </tr>

            <tr>
                <td><input id="formulario_tipo" name="formulario_tipo" type="text" value="Anexo9" hidden> </td>
                <td></td>
            </tr>
