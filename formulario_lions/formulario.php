...
<form id="formulario" name="formulario" action="auxi/salvar.php" method="POST" onsubmit="return validaForm();">
    <table id="tabela" align="center" border="0" width="100%" >
        ...
        <tr>
            ...
            <td><input id="matricula" name="matricula" type="text" maxlength="10" style="width:25%" /> <br>
        ...
        <tr>
            ...
            <td><input id="cpf" name="cpf" type="text" style="width:25%;" onKeyPress="tirarShadow('cpf')" required/><br>
        ...
        <tr>
            ...
            <td id="enderec"><input id="endereco" name="endereco" type="text" maxlength="100" onChange="maiuscula(this)" onKeyUp="maiuscula(this)" style="width:98%"/><span>Endereço</span></td>  
        </tr>
        <tr>
        	<td></td>
            <td id="compl"><input id="complemento" name="complemento" maxlength="100" onChange="maiuscula(this)" onKeyUp="maiuscula(this)" style="width:98%;"/><span>Complemento</span></td>
        </tr>
        <tr>
            ...
            <td><select id="estado" name="estado" required>
                ...
                <option value="PIAUÍ">PIAUÍ</option> </select></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><select id="delegado" name="delegado" onChange="Delegado()" required>
                ...
                <option value="NÃO">NÃO</option></select><br>
        ...
        <tr>
            ...
            <td><select id="cargo_clube" name="cargo_clube" onChange="mostrarQual()" >
                ...
                <option value="OUTRO">OUTRO</option></select></td>
        </tr>
        ...
        <tr>
            ...
            <td><select id="cl_mj" name="cl_mj" required>
            	<option value=""></option>
                <option value="SIM">SIM</option>
                <option value="NÃO">NÃO</option></select></td>
        </tr>
        <tr>
            ...
            <td><select id="prefixo" name="prefixo" required>
                ...
                <option value="Convidado">Convidado</option></select></td>
      	</tr>
        <tr>
            ...
            <td><select id="camisa" name="camisa" required>
                ...
                <option value="GG">GG</option> </select></td>
      	</tr>
        <tr>
            <td></td>
